...
/**
 * @desc  Kill bloginfo('pingback_url')
 */
...
/**
 * @desc Kill trackback rewrite rule
 */
...
/**
 * @desc Prevents WordPress from testing ssl capability on domain.com/xmlrpc.php?rsd
 */
